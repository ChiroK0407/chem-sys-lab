"""
backend/routers/hc_recovery/membrane.py
...
@router.get("/hc-recovery/membrane", include_in_schema=True, summary="Not yet implemented")
async def membrane_not_implemented():
    raise HTTPException(
        status_code=501,
        detail="HC Recovery 'membrane' endpoint is not yet implemented — this is a placeholder stub.",
    )
