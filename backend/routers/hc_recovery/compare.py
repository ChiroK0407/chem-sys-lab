"""
backend/routers/hc_recovery/compare.py
...
@router.get("/hc-recovery/compare", include_in_schema=True, summary="Not yet implemented")
async def compare_not_implemented():
    raise HTTPException(
        status_code=501,
        detail="HC Recovery 'compare' endpoint is not yet implemented — this is a placeholder stub.",
    )
