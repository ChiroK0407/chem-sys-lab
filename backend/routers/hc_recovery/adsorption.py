"""
backend/routers/hc_recovery/adsorption.py
...
@router.get("/hc-recovery/adsorption", include_in_schema=True, summary="Not yet implemented")
async def adsorption_not_implemented():
    raise HTTPException(
        status_code=501,
        detail="HC Recovery 'adsorption' endpoint is not yet implemented — this is a placeholder stub.",
    )
