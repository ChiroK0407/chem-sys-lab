"""
backend/routers/hc_recovery/feed.py
...
@router.get("/hc-recovery/feed", include_in_schema=True, summary="Not yet implemented")
async def feed_not_implemented():
    raise HTTPException(
        status_code=501,
        detail="HC Recovery 'feed' endpoint is not yet implemented — this is a placeholder stub.",
    )
