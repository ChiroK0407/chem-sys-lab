...
EXCHANGER_CLASS_CATALOG = {
    HeatExchangerClass.TEMA_E_SHELL_TUBE: {
        ...
        "typical_u_mid": 600.0,
        "typical_u_max": 900.0,
        "best_for": ["general process cooling", "condensing services", "moderate fouling"],
        "not_suitable_for": ["very high fouling", "severe thermal shock"],
    },
    HeatExchangerClass.TEMA_BEM: {
        ...
        "typical_u_mid": 500.0,
        "typical_u_max": 800.0,
        "best_for": ["clean liquids", "low-to-moderate pressure", "simple revamps"],
        "not_suitable_for": ["heavy fouling", "high thermal cycling"],
    },
    HeatExchangerClass.PLATE_AND_FRAME: {
        ...
        "typical_u_mid": 350.0,
        "typical_u_max": 600.0,
        "best_for": ["heat recovery", "close temperature approach", "food-grade duties"],
        "not_suitable_for": ["very high pressure", "abrasive slurries"],
    },
    HeatExchangerClass.DOUBLE_PIPE: {
        ...
        "typical_u_min": 350.0,
        "typical_u_mid": 700.0,
        "typical_u_max": 1200.0,
        "best_for": ["small modular units", "high-pressure services", "compact skids"],
        "not_suitable_for": ["large throughputs", "very dirty fluids"],
    },
    HeatExchangerClass.AIR_COOLED_FIN_FAN: {
        ...
        "typical_u_mid": 150.0,
        "typical_u_max": 300.0,
        "best_for": ["utility cooling", "remote locations", "dry climates"],
        "not_suitable_for": ["very low ambient temperature", "tight condensers"],
    },
}
